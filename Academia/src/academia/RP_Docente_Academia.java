...
public class RP_Docente_Academia extends javax.swing.JFrame {
Connection con;
    ImageIcon imagen = new ImageIcon("Icono.gif");
    Image icono = imagen.getImage();
    public RP_Docente_Academia() {
        initComponents();
        this.setTitle("Mostrar Reporte de Docente (Academia)");
        try {
            FileWriter f = new FileWriter("ExcelRPDocenteAcademia.txt");
    ...
    private void initComponents() {
        ...
        txtFechaL2.setBounds(330, 180, 30, 30);
        ...
        txtCodigo.setBounds(120, 180, 80, 30);
        ...
        txtFechaL3.setBounds(370, 180, 40, 30);
        ...
        jButton1.setBounds(420, 170, 80, 40);
        ...
        jButton2.setBounds(510, 170, 110, 40);
        ...
        jButton3.setBounds(630, 170, 70, 40);
        jLayeredPane1.add(jButton3, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fondos/ReporteDocenteAcademia.png"))); // NOI18N
        jLabel3.setBounds(60, 30, 610, 70);
        jLayeredPane1.add(jLabel3, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fondos/Fondos/56.jpg"))); // NOI18N
        jLabel4.setBounds(0, 0, 730, 510);
    ...
    public void guardar(){
        validateDir("D:\\Reportes\\TiempoDictado\\Academia",true);
        Object dato[];
        try {
            FileWriter f = new FileWriter("ExcelRPDocenteAcademia.txt");
        ...
        try {
            ...
            CallableStatement cst = con.prepareCall("{call usp_RPTiempoUltimoIntervaloAcademiaProfesor(?,?)}");
            ...
            while(r.next()){
                ...
                try {
                    FileWriter f = new FileWriter("ExcelRPDocenteAcademia.txt",true);
                    PrintWriter p = new PrintWriter(f);
        ...
        try {
            String linea;
            int i=0;
            FileReader m = new FileReader("ExcelRPDocenteAcademia.txt");
        ...
        try {
            FileOutputStream elFichero = new FileOutputStream("D:\\Reportes\\TiempoDictado\\Academia\\"+txtCodigo.getText()+"-"+txtFechaL2.getText()+"-"+txtFechaL3.getText()+".xls");
        ...
        try {
            Process p = Runtime.getRuntime().exec ("rundll32 SHELL32.DLL,ShellExec_RunDLL "+"D:\\Reportes\\TiempoDictado\\Academia\\"+txtCodigo.getText()+"-"+txtFechaL2.getText()+"-"+txtFechaL3.getText()+".xls");
        }   
        catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RP_Docente_Academia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new RP_Docente_Academia().setVisible(true);
            }
        });
    }
