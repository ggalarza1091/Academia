...
public class Listado_Cursos extends javax.swing.JFrame {
    Connection con;
    ImageIcon imagen = new ImageIcon("Icono.gif");
    Image icono = imagen.getImage();
    public Listado_Cursos() {
        initComponents();
        this.setTitle("Listado de Cursos");
    try {
            FileWriter f = new FileWriter("ExcelCursos.txt");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fondos/ListadoCursos.png"))); // NOI18N
        jLabel1.setBounds(90, 10, 396, 76);
        ...
        jButton1.setBounds(130, 140, 143, 45);
        ...
        jButton2.setBounds(370, 140, 53, 46);
        jLayeredPane1.add(jButton2, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fondos/Fondos/63.jpg"))); // NOI18N
        jLabel2.setBounds(0, 0, 590, 260);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            while(r.next()){
                ...
                try {
                    FileWriter f = new FileWriter("ExcelCursos.txt",true);
                    PrintWriter p = new PrintWriter(f);
        ...
        try {
            String linea;
            int i=0;
            FileReader m = new FileReader("ExcelCursos.txt");
        ...
        try {
            FileOutputStream elFichero = new FileOutputStream("D:\\Registros\\ListadoCursos.xls");
        ...
        try {
            Process p = Runtime.getRuntime().exec ("rundll32 SHELL32.DLL,ShellExec_RunDLL "+"D:\\Registros\\ListadoCursos.xls");
        }   
        catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listado_Cursos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Listado_Cursos().setVisible(true);
            }
        });
    }
